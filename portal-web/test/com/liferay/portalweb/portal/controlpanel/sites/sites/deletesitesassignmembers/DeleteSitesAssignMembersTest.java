...
package com.liferay.portalweb.portal.controlpanel.sites.sites.deletesitesassignmembers;
 ...
 */
public class DeleteSitesAssignMembersTest extends BaseTestCase {
	public void testDeleteSitesAssignMembers() throws Exception {
		...
		selenium.waitForPageToLoad("30000");
		selenium.saveScreenShotAndSource();
		selenium.clickAt("//strong/a/span", RuntimeVariables.replace("Global"));
